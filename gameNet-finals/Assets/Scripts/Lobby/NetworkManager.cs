...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public override void OnJoinedRoom() {
        ...
        if (PhotonNetwork.CurrentRoom.CustomProperties.TryGetValue("gameMode", out gameModeName)) {
            ...
            //if (gameMode.Contains("type1")) {
            //    roomGameModeText.text = "type1 Mode";
            //
            //} else if (gameMode.Contains("type2")) {
            //    roomGameModeText.text = "type2 Mode";
            //}
        }
    ...
    public override void OnPlayerPropertiesUpdate(Player targetPlayer, ExitGames.Client.Photon.Hashtable changedProps) {
        ...
        if (playerListObjects.TryGetValue(targetPlayer.ActorNumber, out playerList)) {
            ...
            object isPlayerBlueTeam;
            if (changedProps.TryGetValue(Constants.PLAYER_TEAM, out isPlayerBlueTeam)) {
                playerList.TogglePlayerTeam((bool)isPlayerBlueTeam);
            }
        }
